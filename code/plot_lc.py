...
dmag = Planck15.distmod(z=0.2714).value-Planck15.distmod(0.014).value

# what filter is closest to 4950 rest-frame?
# for LT, it's squarely in g-band
...
#ax.plot(dt_g, mag_g + dmag, c='lightgrey')

# sanity check on the last limit...
limt = 58284.1300-t0_cow
#ax.axvline(x=limt)
