...
def ztf(ax):
    ...
    plum = -20.59
    ax.errorbar(
            trise, plum, xerr=0.05, yerr=0.07, marker='*', c='red', ms=20) 
...
def at2018cow(ax):
    ...
    y = -20.87
    ax.errorbar(
            x, y, xerr=0.08, yerr=0.05, c='red', marker='*', ms=20)
    ax.text(x*1.1, y, "AT2018cow", fontsize=textsize+2,
...
def ibn(ax):
    ...
    ax.text(x*1.05, y, "iPTF15ul", fontsize=textsize,
        horizontalalignment='left')
...
fig.tight_layout()
plt.savefig("lum_rise_hst.png", dpi=500)
